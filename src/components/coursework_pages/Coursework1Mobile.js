         ...
         <div className="coursework1-mobile">
            <div className="coursework1-top-mobile">
               <div className="coursework1-course-box-mobile">
                  <button className={this.state.c1 ? "coursework1-course-clicked-mobile" : "coursework1-course-mobile"} onClick={this.handleClick_c1}>CMSC131</button>
               ...
               <div className="coursework1-course-box-mobile">
                  <button className={this.state.c2 ? "coursework1-course-clicked-mobile" : "coursework1-course-mobile"} onClick={this.handleClick_c2}>MATH140</button>
               ...
               <div className="coursework1-course-box-mobile">
                  <button className={this.state.c3 ? "coursework1-course-clicked-mobile" : "coursework1-course-mobile"} onClick={this.handleClick_c3}>JOUR282</button>
               ...
               <div className="coursework1-course-box-mobile">
                  <button className={this.state.c4 ? "coursework1-course-clicked-mobile" : "coursework1-course-mobile"} onClick={this.handleClick_c4}>COMM107</button>
               ...
               <div className="coursework1-course-box-mobile">
                  <button className={this.state.c5 ? "coursework1-course-clicked-mobile" : "coursework1-course-mobile"} onClick={this.handleClick_c5}>HLTH234</button>
