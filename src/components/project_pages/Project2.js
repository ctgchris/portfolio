     ...
     <div className="L-project-page">
         ...
         <div className="p2-L-project-desc-box">
            ...
            <div className="L-project-desc">
               <p className="L-project-desc-text">A web app I built with the Spoonacular API that generates recipes and weekly meal plans based on the user’s dietary preferences.</p>
            </div>
