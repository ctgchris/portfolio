  ...
  return (
    <div id="About" className="about">
      ...
      <div className="about-right">
         ...
         <p className="about-text">Hi! My name is Christopher Giang and I am a student at the University of Maryland passionate about math, computer science, and problem solving. I have experience with object-oritented programming, front-end development as well as back-end programming. I hope to use my skills to make a difference and love using technology to shape the world around me.</p>
         <p className="about-text">Outside of academics, I have a variety of interests and hobbies I like to pursue, including teaching, volleyball, weightlifting, cooking, and watch-collecting.</p>
