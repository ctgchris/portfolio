  ...
  return (
    <div id="AboutMobile" className="about-mobile">
      ...
      <div className="about-box-mobile">
         ...
         <p className="about-text-mobile">Hi! My name is Christopher Giang and I am a student at the University of Maryland passionate about math, computer science, and problem solving. I have experience with front-end development as well as back-end programming. I hope to use my skills to make a difference and love using technology to shape the world around me.</p>
         <p className="about-text-mobile">Outside of academics, I have a variety of interests and hobbies I like to pursue, including web development, Volleyball, weightlifting, learning Spanish, and teaching.</p>
         ...
         <div className="langs-box-mobile">
            ...
            <div className="langs-split-mobile">
               <div className="lang-box-mobile">
                  <img src={arrow} className="lang-logo-mobile"/>
                  <p className="lang-text-mobile">NodeJS</p>
               </div>
               <div className="lang-box-mobile">
                  <img src={arrow} className="lang-logo-mobile"/>
