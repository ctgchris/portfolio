           ...
           <div className="coursework-box-mobile">
              ...
              <div className="coursework-menu-mobile">
                  <div className="coursework-menu-buttons-mobile">
                     <button id="coursework-button1-mobile" className={this.state.f22 ? "coursework-menu-button-clicked-mobile" : "coursework-menu-button-mobile"} onClick={this.handleClick_f22}>Fall 2023</button>
                     <button id="coursework-button2-mobile" className={this.state.s22 ? "coursework-menu-button-clicked-mobile" : "coursework-menu-button-mobile"} onClick={this.handleClick_s22}>Spring 2023</button>
                     <button id="coursework-button3-mobile" className={this.state.f21 ? "coursework-menu-button-clicked-mobile" : "coursework-menu-button-mobile"} onClick={this.handleClick_f21}>Fall 2022</button>
                     <button id="coursework-button4-mobile" className={this.state.s21 ? "coursework-menu-button-clicked-mobile" : "coursework-menu-button-mobile"} onClick={this.handleClick_s21}>Spring 2022</button>
                     <button id="coursework-button5-mobile" className={this.state.f20 ? "coursework-menu-button-clicked-mobile" : "coursework-menu-button-mobile"} onClick={this.handleClick_f20}>Fall 2021</button>
                  </div>
