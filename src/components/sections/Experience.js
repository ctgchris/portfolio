               ...
               <div className="experience-content">
                  <div className="experience-menu">
                     ...
                     <div className="experience-menu-buttons">
                        <button id="experience-button1" className={this.state.msft ? "experience-menu-button-clicked" : "experience-menu-button"} onClick={this.handleClick_msft}>University of Maryland</button>
                        <button id="experience-button2" className={this.state.panw ? "experience-menu-button-clicked" : "experience-menu-button"} onClick={this.handleClick_panw}>General Dynamics IT</button>
                        <button id="experience-button3" className={this.state.mnsm ? "experience-menu-button-clicked" : "experience-menu-button"} onClick={this.handleClick_mnsm}>Tommy Hilfiger</button>
                     </div>
                  </div>
