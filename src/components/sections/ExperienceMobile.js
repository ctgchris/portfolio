           ...
           <div className="experience-box-mobile">
              ...
              <div className="experience-menu-mobile">
                  <div className="experience-menu-buttons-mobile">
                     <button id="experience-button1-mobile" className={this.state.msft ? "experience-menu-button-clicked-mobile" : "experience-menu-button-mobile"} onClick={this.handleClick_msft}>UMD</button>
                     <button id="experience-button2-mobile" className={this.state.panw ? "experience-menu-button-clicked-mobile" : "experience-menu-button-mobile"} onClick={this.handleClick_panw}>GDIT</button>
                     <button id="experience-button3-mobile" className={this.state.mnsm ? "experience-menu-button-clicked-mobile" : "experience-menu-button-mobile"} onClick={this.handleClick_mnsm}>Tommy Hilfiger</button>
                  </div>
