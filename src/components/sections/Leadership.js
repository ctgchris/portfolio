         ...
         <div id="Leadership" className="leadership">
            <div className="leadership-box">
               <div className="leadership-title-box">
                  ...
                  <p className="leadership-title-text">Club Involvement</p>
                ...
                <div className="leadership-content">
                  <div className="leadership-menu">
                     ...
                     <div className="leadership-menu-buttons">
                        ...
                        <button id="leadership-button2" className={this.state.ws ? "leadership-menu-button-clicked" : "leadership-menu-button"} onClick={this.handleClick_ws}>Bitcamp</button>
                     </div>
                  </div>
