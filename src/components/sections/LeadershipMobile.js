         ...
         <div id="LeadershipMobile" className="leadership-mobile">
           ...
           <div className="leadership-box-mobile">
              <div className="leadership-title-box-mobile">
                 ...
                 <p className="leadership-title-text-mobile">Club Involvement</p>
              ...
              <div className="leadership-menu-mobile">
                  <div className="leadership-menu-buttons-mobile">
                     ...
                     <button id="leadership-button2-mobile" className={this.state.ws ? "leadership-menu-button-clicked-mobile" : "leadership-menu-button-mobile"} onClick={this.handleClick_ws}>Bitcamp</button>
                  </div>
